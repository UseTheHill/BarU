    ...
    <>
      <div id="guest" class="flex justify-center p-8...">
        <p className="text-lg font-light leading-relaxed mt-6 mb-4 text-blueGray-800">
          Most bars have created specialty cocktail menus but if you want a drink off menu,<br /> BarU is here to help.
          Search for some of the best bar drinks and order while at the <br />restaurant.<br />
          
          <br />Once you have your drink you can create a post in your account where you can share <br />the name of the drink,
          the bar you got it from and whether or not you liked it.
        </p>
      </div>
      {
